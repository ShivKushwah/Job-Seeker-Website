<%-- 
    Document   : previousinterviews
    Created on : Jul 4, 2016, 1:44:13 AM
...
<table class="table" class="table-responsive">
  ...
  <div class="col-sm-8">
  <p style="background-color:#3CF; color:#000; padding:10px;" align="center">PREVIOUS <span style="font-family:Impact; background-color:#0CF; color:#FC6"> INTERVIEWS </span></p>
