<%-- 
    Document   : jobseekerlogin
    Created on : Jul 4, 2016, 9:30:00 AM
...
<table class="table"  class="table-responsive">
    ...
    <tbody>
      <tr>
        ...
        <td><a href="#">Job Seeker Zone</a></td>
...
<table class="table" class="table-responsive">
  ...
  <div class="col-sm-8">
  <p style="background-color:#3CF; color:#000; padding:10px;" align="center">LOGIN <span style="font-family:Impact; background-color:#0CF; color:#FC6"> NOW! </span></p>
