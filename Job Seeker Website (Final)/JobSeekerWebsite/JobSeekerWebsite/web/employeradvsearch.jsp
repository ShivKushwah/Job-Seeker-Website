<%-- 
    Document   : employeradvsearch
    Created on : Jul 4, 2016, 1:02:33 AM
...
<table class="table">
  ...
  <div class="col-sm-8">
  <p style="background-color:#3CF; color:#000; padding:10px;" align="center">ADVANCED  <span style="font-family:Impact; background-color:#0CF; color:#FC6"> SEARCH </span></p>
        <form name="form1" method="post" action="">
          <table width="761" height="167" border="0" style="margin-left:150px; margin-top:50px">
            <tr>
              <td width="224">&nbsp;</td>
              <td width="235">&nbsp;</td>
              <td width="211">&nbsp;</td>
              <td width="159"><input type="submit" name="logout" id="logout" value="Logout"></td>
            </tr>
            <tr>
              <td>Key Skills: 
                <label for="keyskills"></label>
              <input type="text" name="keyskills" id="keyskills"></td>
              <td>Experience:              
              ...
              <td>Location:              
                <label for="experience"></label>
                <select name="location" id="experience">
              </select></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td><input type="submit" name="update" id="update" value="Update"></td>
              <td><input type="submit" name="Search City" id="Search City" value="Search by City"></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
          </table>
