<%-- 
    Document   : itskills
    Created on : Jul 4, 2016, 12:38:45 AM
...
<table class="table" class="table-responsive">
  ...
  <div class="col-sm-8">
  <p style="background-color:#3CF; color:#000; padding:10px;" align="center"> IT <span style=" font-family:Impact; background-color:#0CF; color:#FC6"> SKILLS</span></p>
  
        <form name="form1" method="post" action="">
          <table width="729" border="0" align="center" class="table-responsive">
            <tr>
              <td width="144"><label for="email"></label>
              <input type="text" name="email" id="email"></td>
              <td width="300">&nbsp;</td>
              <td width="129"><input type="submit" name="logout" id="logout" value="Logout"></td>
            </tr>
            <tr>
              <td height="49">Skills</td>
              <td><label for="skills"></label>
              <input type="text" name="skills" id="skills"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td height="43">Location</td>
              <td><label for="location"></label>
              <input type="text" name="location" id="location"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td height="60">Experience</td>
              <td><label for="experience"></label>
              <input type="text" name="experience" id="experience"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
