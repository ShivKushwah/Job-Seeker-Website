...
<table class="table" class="table-responsive">
  ...
  <div class="col-sm-8">
  <p style="background-color:#3CF; color:#000; padding:10px;" align="center">ADVANCED JOB <span style="font-family:Impact; background-color:#0CF; color:#FC6"> SEARCH </span></p>
        <form name="form1" method="post" action="">
          <table width="761" height="167" border="0" align="center" class="table-responsive">
            <tr>
              <td width="224">&nbsp;</td>
              <td width="235">&nbsp;</td>
              <td width="211">&nbsp;</td>
            ...
            <tr>
              ...
              <td>Experience:
              <input type="text" name="keyskills2" id="keyskills2"></td>
              <td>Location: 
              <input type="text" name="keyskills3" id="keyskills3"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
