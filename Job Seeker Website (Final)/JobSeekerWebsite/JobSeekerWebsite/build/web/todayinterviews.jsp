<%-- 
    Document   : todayinterviews
    Created on : Jul 4, 2016, 1:12:35 AM
...
<table class="table" class="table-responsive">
  ...
  <div class="col-sm-8">
  <p style="background-color:#3CF; color:#000; padding:10px;" align="center">TODAY'S <span style="font-family:Impact; background-color:#0CF; color:#FC6"> INTERVIEWS </span></p>
    <form name="form1" method="post" action="">
      <table width="737" border="0" align="center" class="table-responsive">
        <tr>
          <td width="547">&nbsp;</td>
          <td width="174"><input type="submit" name="logout" id="logout" value="Logout"></td>
        </tr>
      </table>
    </form>
</div>
