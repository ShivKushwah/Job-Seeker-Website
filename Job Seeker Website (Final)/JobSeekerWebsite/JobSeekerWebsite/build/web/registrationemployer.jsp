...
<table class="table"  class="table-responsive">
  ...
  <div class="col-sm-8">
  <p style="background-color:#3CF; color:#000; padding:10px;" align="center">NEW CLIENT<span style="font-family: Impact; color: #FC6; background-color: #0CF"> </span><span style="font-family:Impact; background-color:#0CF; color:#FC6">REGISTRATION </span></p>
    <form name="form1" method="post" action="">
      <table width="414" border="0"align="center" class="table-responsive">
        <tr>
